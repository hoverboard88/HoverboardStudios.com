  ...
  <div class="wrap wrap--green wrap--gradient">
    <header class="container container--top-bottom-padding">
      ...
      <div class="feature-block centered">
        ...
        <p class="mission">We believe in your collaboration throughout every part of your project. From design ideas and inspiration to branding and implementation, Hoverboard is determined to bring your audience the very best experience to the web.</p>
        <p class="tagline tagline-small"><strong>We are your next right-hand design and development studio.</strong></p>
      ...
      <section class="portfolio">
        ...
        <div class="portfolio__item">
          ...
          <div class="portfolio__example">
            <img src="http://placehold.it/350x350/24408f" alt="">
          </div>
        </div>
        <div class="portfolio__item">
          <div class="portfolio__summary">
