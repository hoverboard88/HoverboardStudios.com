					...
					<div class="post__social menu--social">
						<ul>
							<?php if (get_field('social_twitter', $user)) { ?>
								<li><a href="https://twitter.com/<?php the_field('social_twitter', $user); ?>">
							...
							<li><a href="https://www.linkedin.com/in/<?php the_field('social_linkedin', $user); ?>">
								<svg style="width:24px;height:24px" viewBox="0 0 24 24">
							...
							<?php } ?>
							<li><a href="<?php echo esc_url( home_url( '/author/rtvenge/feed/' ) ); ?>">
								<svg style="width:24px;height:24px" viewBox="0 0 24 24">
							...
							<li><a href="https://www.linkedin.com/in/<?php the_field('social_github', $user); ?>">
								<svg style="width:24px;height:24px" viewBox="0 0 24 24">
