    ...
    <div class="portfolio__items">
      <div class="portfolio__item">
        ...
        <div class="portfolio__example">
          <img src="<?php bloginfo('template_directory'); ?>/dist/img/portfolio_supcamp.png" alt="">
        </div>
      </div>
      <div class="portfolio__item">
        <div class="portfolio__summary">
        ...
        <div class="portfolio__example">
          <img src="<?php bloginfo('template_directory'); ?>/dist/img/portfolio_standarddist.png" alt="">
        </div>
      </div>
    </div>
  </section>
