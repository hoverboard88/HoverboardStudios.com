...
<article id="post-<?php the_ID(); ?>" <?php post_class('portfolio__item'); ?>>
	...
	<div class="portfolio__summary">
		<header class="entry-header">
			...
			<a href="<?php the_field('study_url', get_the_ID()) ?>" class="portfolio__website">
	...
	<div class="portfolio__example">
		<?php echo wp_get_attachment_image(get_field('study_screenshot_mobile', get_the_ID())['id'], 'large'); ?>
	</div>
